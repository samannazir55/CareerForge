...
# ---- Stage 1: Install dependencies ------------------------------------------
    ...
    # Chromium for the apps/web build-time prerender step (scripts/prerender.mjs).
    # Same package + shared-library list as the production stage below (that
    # list is already proven to work with this base image for the Puppeteer
    # PDF-export feature) — needed here too since `npm run build -w apps/web`
    # now launches headless Chromium as part of the build.
