...
import type { ProfileFact, ProfileFactCategory } from '@careerforge/schema';

// ---------------------------------------------------------------------------
// Category configuration — defines display order, icons, and labels
// ---------------------------------------------------------------------------
    ...
    <AppShell>
      <div className="min-h-full bg-background p-6 md:p-10">
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          {/* Main content — category tabs + facts */}
          {profile && !isLoading && (
